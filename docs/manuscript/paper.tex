...
We thank the Allele Frequency Net Database team for maintaining public access to the data used here, and the TJHSST research program for institutional support.

\section*{Code and data availability}
All analysis code, data-fetching scripts, and figure-generation code are available at \url{https://github.com/shawnli1028/hla-equity-sim}. Raw AFND downloads are deposited with SHA-256 checksums in \texttt{data/raw/SOURCES.md}.
