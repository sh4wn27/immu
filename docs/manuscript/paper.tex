...
All analysis code, data-fetching scripts, figure generators, and tests are available at \url{hhttps://github.com/sh4wn27/immu}. The random-number-generator seed is fixed at \texttt{20260424}; every script re-derives that seed via \texttt{numpy.random.default\_rng} rather than mutating global state. Figures 2--5 can be regenerated end-to-end from the repository root with:
\begin{verbatim}
...
\subsection{Reproducibility}
All analysis code is available at \url{https://github.com/sh4wn27/immu}. The random-number-generator seed is fixed at \texttt{20260424}. Figures 2--5 can be regenerated end-to-end from the repository root with:
\begin{verbatim}
